...
describe('TuneInScreen', () => {
    ...
    it('selects a station on the device and returns to the device screen', async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith('http://192.168.1.187:8000/api/control/devices/192.168.1.187/providers/tunein/play', expect.objectContaining({
            method: 'POST',
    ...
    it('browses TuneIn categories on the targeted device', async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith('http://192.168.1.187:8000/api/control/providers/tunein/navigate', undefined);

        fireEvent.press(screen.getByLabelText('Browse Local Radio'));
        await waitFor(() => expect(global.fetch).toHaveBeenCalledWith(
            'http://192.168.1.187:8000/api/control/providers/tunein/navigate/aHR0cDovL29wbWwucmFkaW90aW1lLmNvbS9Ccm93c2UuYXNoeD9jPWxvY2FsJnJlbmRlcj1qc29u',
            undefined
        ));
